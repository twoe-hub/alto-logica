...
insert into public.company (id, email, password, name, address, phone, website, incorp_date) values (uuid_generate_v4(), :email, :password, :name, :address, :phone, :website, :incorp-date)
